...
describe('ServiceContainer Integration', function () {
    describe('container compilation', function () {
        ...
        test('container instantiates successfully with test config', function () {
    ...
    describe('repository provisioning', function () {
        ...
        test('provides DashboardRepository instance', function () {
            ...
            expect($repository)->toBeInstanceOf(DashboardRepositoryInterface::class);
        });
        ...
        test('provides FavoriteRepository instance', function () {
            ...
            expect($repository)->toBeInstanceOf(FavoriteRepositoryInterface::class);
        });
    ...
    describe('dependency injection verification', function () {
        test('all services are properly wired with their dependencies', function () {
            $container = createContainerInstance();

            // Services should all be instantiable and return the expected types
            expect($container->getLinkService())->toBeInstanceOf(LinkServiceInterface::class);
            expect($container->getCategoryService())->toBeInstanceOf(CategoryServiceInterface::class);
            expect($container->getDashboardService())->toBeInstanceOf(DashboardServiceInterface::class);
            expect($container->getFavoriteService())->toBeInstanceOf(FavoriteServiceInterface::class);
            expect($container->getTagService())->toBeInstanceOf(TagServiceInterface::class);
        });

        test('DatabaseRepository instances share the same database connection', function () {
            $container = createContainerInstance();
