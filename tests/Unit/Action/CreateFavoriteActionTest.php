...
describe("CreateFavoriteAction", function () {
    ...
    describe("validate method", function () {
        test(
            "passes validation with valid dashboard_id and link_id",
            function () {
    ...
    describe("execute method", function () {
        test(
            "executes with valid data and returns formatted favorite",
            function () {
                $favoriteService = Mockery::mock(
                    FavoriteServiceInterface::class,
                );
        ...
        test(
            "calls favoriteService.addFavorite with correct UUID objects",
            function () {
                $favoriteService = Mockery::mock(
                    FavoriteServiceInterface::class,
                );
