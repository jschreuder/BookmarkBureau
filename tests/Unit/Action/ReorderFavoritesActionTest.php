...
describe('ReorderFavoritesAction', function () {
    describe('filter method', function () {
        test('filters dashboard_id and links', function () {
            ...
            $action = new FavoriteReorderAction($favoriteService, $inputSpec, $outputSpec);
    ...
    describe('execute method', function () {
        test('calls favoriteService.reorderFavorites with correct parameters', function () {
            $favoriteService = Mockery::mock(FavoriteServiceInterface::class);
        ...
        test('returns array of transformed favorites', function () {
            ...
            $result = $action->execute([
                ...
                'links' => [
                    ['link_id' => $favorite1->link->linkId->toString(), 'sort_order' => 1],
                    ['link_id' => $favorite2->link->linkId->toString(), 'sort_order' => 2],
                ],
            ]);
        ...
        test('transforms each favorite with correct sort_order', function () {
            ...
            $result = $action->execute([
                'dashboard_id' => $favorite1->dashboard->dashboardId->toString(),
                'links' => [
                    ['link_id' => $favorite1->link->linkId->toString(), 'sort_order' => 5],
                    ['link_id' => $favorite2->link->linkId->toString(), 'sort_order' => 10],
                ],
            ]);
