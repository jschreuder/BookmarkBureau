...
use jschreuder\BookmarkBureau\Action\DeleteCategoryAction;
...
describe('DeleteCategoryAction', function () {
    describe('filter method', function () {
        test('trims whitespace from id', function () {
            ...
            $action = new DeleteCategoryAction($categoryService, $inputSpec);
