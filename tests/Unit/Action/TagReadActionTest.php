...
describe('TagReadAction', function () {
    describe('filter method', function () {
        test('filters tag_name and trims whitespace', function () {
            ...
            $action = new TagReadAction($tagService, new TagNameInputSpec(), new TagOutputSpec());
    ...
    describe('execute method', function () {
        test('returns tag when found in list', function () {
            ...
            $collection = new \jschreuder\BookmarkBureau\Collection\TagCollection($tag);

            $tagService->shouldReceive('listAllTags')
                ->once()
        ...
        test('throws TagNotFoundException when tag not found', function () {
            ...
            $collection = new \jschreuder\BookmarkBureau\Collection\TagCollection();

            $tagService->shouldReceive('listAllTags')
                ->once()
                ->andReturn($collection);

            expect(fn() => $action->execute(['tag_name' => 'nonexistent']))
