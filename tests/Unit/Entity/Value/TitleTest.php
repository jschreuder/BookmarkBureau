...
describe("Title Value Object", function () {
    ...
    describe("invalid titles", function () {
        ...
        test(
            "throws exception for significantly exceeding maximum length",
            function () {
        ...
        test(
            "throws exception for text exceeding 255 characters after trimming",
            function () {
                $tooLongTitle = "  " . str_repeat("a", 256) . "  ";
    ...
    describe("immutability", function () {
        test("Title value object is immutable", function () {
            ...
            expect(fn() => ($title->value = "Modified Title"))->toThrow(
                Error::class,
            );
        });
    });
    ...
    describe("equals method", function () {
        test("equals returns true for same title value", function () {
            $title1 = new Title("My Title");
            $title2 = new Title("My Title");

            expect($title1->equals($title2))->toBeTrue();
        });

        test("equals returns false for different title values", function () {
            $title1 = new Title("Title One");
            $title2 = new Title("Title Two");

            expect($title1->equals($title2))->toBeFalse();
        });

        test(
            "equals returns true when comparing titles with same trimmed value",
            function () {
                $title1 = new Title("  My Title  ");
                $title2 = new Title("My Title");
        ...
        test(
            ...
            function () {
                ...
                expect($title->equals($stdObject))->toBeFalse();
            },
        );
        ...
        test(
            ...
            function () {
                ...
                expect($title->equals($icon))->toBeFalse();
            },
        );
