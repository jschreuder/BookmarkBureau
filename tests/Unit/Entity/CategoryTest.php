...
describe("Category Entity", function () {
    ...
    describe("dashboard getter", function () {
        ...
        test("dashboard is readonly and cannot be modified", function () {
            ...
            expect(
                fn() => ($category->dashboard = TestEntityFactory::createDashboard()),
            )->toThrow(Error::class);
        });
    });
    ...
    describe("title getter and setter", function () {
        ...
        test("setting title calls markAsUpdated", function () {
            ...
            expect($category->updatedAt->getTimestamp())->toBeGreaterThan(
    ...
    describe("createdAt getter", function () {
        test("getting createdAt returns the creation timestamp", function () {
            ...
            expect($category->createdAt)->toBe($createdAt);
            expect($category->createdAt)->toBeInstanceOf(
        ...
        test("createdAt is readonly and cannot be modified", function () {
            ...
            expect(
                fn() => ($category->createdAt = new DateTimeImmutable()),
            )->toThrow(Error::class);
        });
    });
    ...
    describe("updatedAt getter", function () {
        test("getting updatedAt returns the update timestamp", function () {
            ...
            expect($category->updatedAt)->toBe($updatedAt);
            expect($category->updatedAt)->toBeInstanceOf(
                DateTimeInterface::class,
            );
        });
    ...
    describe("immutability constraints", function () {
        test("categoryId cannot be modified", function () {
            ...
            expect(fn() => ($category->categoryId = Uuid::uuid4()))->toThrow(
                Error::class,
            );
        });
    });
    ...
    describe("equals method", function () {
        test("equals returns true for same category ID", function () {
        ...
        test("equals returns false for different category IDs", function () {
            $categoryId1 = Uuid::uuid4();
            $categoryId2 = Uuid::uuid4();
            $dashboard = TestEntityFactory::createDashboard();
            $title = new Title("Test Category");
            ...
            expect($category1->equals($category2))->toBeFalse();
        });
        ...
        test(
            ...
            function () {
                ...
                expect($category->equals($link))->toBeFalse();
            },
        );
        ...
        test(
            ...
            function () {
                ...
                expect($category->equals($stdObject))->toBeFalse();
            },
        );
    });
});
