...
describe("DashboardInputSpec", function () {
    ...
    describe("filter method", function () {
        ...
        test("strips HTML tags from title", function () {
            ...
            $filtered = $spec->filter([
                "dashboard_id" => $dashboardId,
                "title" =>
                    '<script>alert("xss")</script>Test<strong>Bold</strong>',
                "description" => "A test",
            ]);
        ...
        test("strips HTML tags from description", function () {
            ...
            $filtered = $spec->filter([
                ...
                "title" => "Test",
                "description" =>
                    "<p>A test</p> <script>bad</script>description",
            ]);
        ...
        test("handles missing description key with null", function () {
            $spec = new DashboardInputSpec();
            $dashboardId = Uuid::uuid4()->toString();
    ...
    describe("validate method", function () {
        ...
        test(
            "passes validation with optional description and icon as null",
            function () {
                $spec = new DashboardInputSpec();
                $dashboardId = Uuid::uuid4()->toString();
