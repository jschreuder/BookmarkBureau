...
describe('TagService', function () {
    describe('listAllTags method', function () {
        test('returns all tags from repository', function () {
            ...
            $tagRepository->shouldReceive('findAll')
                ->once()
            ...
            $service = new TagService($tagRepository, $linkRepository, $unitOfWork);
    ...
    describe('getTagsForLink method', function () {
        test('returns tags for a specific link', function () {
            ...
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('findTagsForLinkId')
                ->with($linkId)
                ->once()
                ->andReturn($tagCollection);
        ...
        test('throws LinkNotFoundException when link does not exist', function () {
            ...
            expect(fn() => $service->getTagsForLink($linkId))
    ...
    describe('createTag method', function () {
        test('creates a new tag with name and color', function () {
            ...
            expect($result)->toBeInstanceOf(\jschreuder\BookmarkBureau\Entity\Tag::class);
        ...
        test('throws DuplicateTagException when tag already exists', function () {
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('save')
                ->once()
            ...
            expect(fn() => $service->createTag('existing-tag', '#FF5733'))
        ...
        test('throws InvalidArgumentException on invalid color format', function () {
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $linkRepository = Mockery::mock(LinkRepositoryInterface::class);
            $unitOfWork = Mockery::mock(UnitOfWorkInterface::class);
            $unitOfWork->shouldReceive('transactional')
            ...
            expect(fn() => $service->createTag('new-tag', 'invalid-color'))
    ...
    describe('updateTag method', function () {
        test('updates an existing tag with new color', function () {
            ...
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('findByName')
                ->with('my-tag')
                ->once()
                ->andReturn($tag);
            $tagRepository->shouldReceive('save')->once();
        ...
        test('throws TagNotFoundException when tag does not exist', function () {
            ...
            expect(fn() => $service->updateTag('nonexistent-tag', '#FF5733'))
    ...
    describe('deleteTag method', function () {
        ...
        test('throws TagNotFoundException when tag does not exist', function () {
            ...
            expect(fn() => $service->deleteTag('nonexistent-tag'))
                ->toThrow(TagNotFoundException::class);
        });
    ...
    describe('assignTagToLink method', function () {
        test('assigns an existing tag to a link', function () {
            ...
            $tagRepository->shouldReceive('findByName')
                ...
                ->once()
                ->andReturn($tag);
            $tagRepository->shouldReceive('isAssignedToLinkId')
                ->with($linkId, 'my-tag')
                ->once()
                ->andReturn(false);
        ...
        test('throws LinkNotFoundException when link does not exist', function () {
            ...
            expect(fn() => $service->assignTagToLink($linkId, 'my-tag'))
                ->toThrow(LinkNotFoundException::class);
        });
        ...
        test('wraps assign operation in a transaction', function () {
            ...
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('findByName')->andReturn($tag);
            $tagRepository->shouldReceive('isAssignedToLinkId')->andReturn(false);
            $tagRepository->shouldReceive('assignToLinkId');
    ...
    describe('searchTags method', function () {
        test('searches tags by query with default limit', function () {
            ...
            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('searchByName')
                ->with('api', 20)
                ->once()
                ->andReturn($tagCollection);
    ...
    describe('integration scenarios', function () {
        test('full workflow: create, assign, list, and delete tags', function () {
            $linkId = Uuid::uuid4();
            $link = TestEntityFactory::createLink(id: $linkId);
            $tag = TestEntityFactory::createTag(tagName: new TagName('important'));
            ...
            $tagRepository->shouldReceive('save')->once();
            // For getTagsForLink
            $tagRepository->shouldReceive('findTagsForLinkId')->andReturn($tagCollection);
            // For assignTagToLink
            $tagRepository->shouldReceive('findByName')->andReturn($tag);
            $tagRepository->shouldReceive('isAssignedToLinkId')->andReturn(false);
            $tagRepository->shouldReceive('assignToLinkId');
            // For listAllTags
            $tagRepository->shouldReceive('findAll')->andReturn($tagCollection);
            // For deleteTag
            $tagRepository->shouldReceive('delete');
        ...
        test('multiple tags management workflow', function () {
            ...
            $tag2 = TestEntityFactory::createTag(tagName: new TagName('laravel'));
            $tagsCollection = new TagCollection($tag1, $tag2);
            $searchResult = new TagCollection($tag1);

            $tagRepository = Mockery::mock(TagRepositoryInterface::class);
            $tagRepository->shouldReceive('save')->times(2);
            $tagRepository->shouldReceive('findAll')->andReturn($tagsCollection);
            $tagRepository->shouldReceive('searchByName')
                ->with('php', 20)
