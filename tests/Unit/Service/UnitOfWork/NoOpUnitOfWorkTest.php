...
describe('NoOpUnitOfWork', function () {
    ...
    describe('transactional operation', function () {
        ...
        test('re-throws original exception without modification', function () {
            ...
            try {
                $unitOfWork->transactional(function () use ($originalException) {
    ...
    describe('nested transaction handling', function () {
        ...
        test('requires matching number of commits for nested transactions', function () {
            $unitOfWork = new NoOpUnitOfWork();
            $unitOfWork->begin();
            $unitOfWork->begin();
            $unitOfWork->begin();
    ...
    describe('no-op behavior', function () {
        ...
        test('suitable for storage backends without transaction support', function () {
            $unitOfWork = new NoOpUnitOfWork();
        ...
        test('preserves closure execution even without actual transactions', function () {
            $unitOfWork = new NoOpUnitOfWork();
            $sideEffect = 0;
