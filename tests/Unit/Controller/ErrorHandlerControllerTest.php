...
describe('ErrorHandlerController', function () {
    ...
    describe('execute method', function () {
        ...
        test('returns 401 for unauthenticated exception with code 401', function () {
            $logger = Mockery::mock(LoggerInterface::class);
            $logger->shouldReceive('log')
        ...
        test('returns 403 for unauthorized exception with code 403', function () {
            $logger = Mockery::mock(LoggerInterface::class);
            $logger->shouldReceive('log')
        ...
        test('logs exception with correct severity level and message', function () {
            $logger = Mockery::mock(LoggerInterface::class);
            $logger->shouldReceive('log')
                ->with(404, 'Server error')
                ->once();
