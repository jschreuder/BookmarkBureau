...
final class ReorderCategoryLinksInputSpec implements InputSpecInterface
{
    private const array FIELDS = ["category_id", "links"];
    ...
    /** @return array{category_id: string, links: array<int, array{link_id: string, sort_order: int}>} */
    #[\Override]
    public function filter(array $rawData, ?array $fields = null): array
    {
        ...
        /** @var array{category_id: string, links: array<int, array{link_id: string, sort_order: int}>} */
        return $filtered;
    }
